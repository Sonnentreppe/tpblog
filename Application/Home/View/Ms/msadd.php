...
<div style="width:632px;margin: 0 auto;text-align:center">
		...
		<script>
            swfobject.addDomLoadEvent(function () {
				...
				var swf = new fullAvatarEditor("__PUBLIC__/photo/fullAvatarEditor.swf", "__PUBLIC__/photo/expressInstall.swf", "swfContainer", {
					    id : 'swf',
						upload_url : "{:U('Home/Ms/uploadImg',array('id'=>'1'))}",	//上传接口
